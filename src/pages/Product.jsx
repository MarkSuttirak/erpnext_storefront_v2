...
const Product = () => {
    ...
    return (
      <>
        ...
        <main className="lg:mt-[92px] desktop-sec lg:pt-10">
          <div className='lg:flex gap-x-[72px]'>
            ...
            <div className='w-full'>
              ...
              <div className='flex p-[30px] lg:px-0 justify-between border-y border-y-[#E3E3E3]'>
              ...
              <div className='p-[30px] lg:px-0 border-b border-b-[#E3E3E3]'>
