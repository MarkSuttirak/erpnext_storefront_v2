...
export default function BlogPage(){
  ...
  const BlogCard = ({title, image, date, link}) => {
    return (
      <Link to={link} className="w-full">
        <img src={`${import.meta.env.VITE_ERP_URL}${image}`} className='rounded-md w-full object-cover max-h-[200px]'/>
  ...
  return (
    <>
      ...
      <main className="main-margintop desktop-sec px-5 lg:py-10">
        <Breadcrumbs pages={[{
          name:'Home',
          href:'/'
        }, {
